...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidRoomLibraryAccessors laccForAndroidRoomLibraryAccessors = new AndroidRoomLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.room</b>
         */
        public AndroidRoomLibraryAccessors getRoom() {
            return laccForAndroidRoomLibraryAccessors;
        }

    }

    public static class AndroidRoomLibraryAccessors extends SubDependencyFactory {

        public AndroidRoomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            return create("android.room.compiler");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("android.room.ktx");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getRuntime() {
            return create("android.room.runtime");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp</b> with value <b>1.9.0-1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.room</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
